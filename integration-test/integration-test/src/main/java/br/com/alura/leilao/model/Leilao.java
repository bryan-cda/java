...
public class Leilao {
	...
	public Leilao(@NotNull @NotBlank String nome, @NotNull @DecimalMin("0.1") BigDecimal valorInicial, @NotNull User user) {
		this.nome = nome;
		this.valorInicial = valorInicial;
		this.user = user;
	...
	public Leilao(@NotNull @NotBlank String nome, @NotNull @DecimalMin("0.1") BigDecimal valorInicial, @NotNull LocalDate data, @NotNull User user) {
		this.nome = nome;
		this.valorInicial = valorInicial;
		this.user = user;
